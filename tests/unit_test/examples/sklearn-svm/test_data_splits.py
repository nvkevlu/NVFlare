...
"""Tests for data splitting logic in sklearn-svm example."""

import sys
from pathlib import Path

# Add sklearn-svm example directory to path to import calculate_data_splits
example_dir = Path(__file__).parent.parent.parent.parent.parent / "examples" / "advanced" / "sklearn-svm"
sys.path.insert(0, str(example_dir))

from job import calculate_data_splits


class TestSVMDataSplits:
    """Tests for SVM calculate_data_splits function."""
